...
public class MyService : ServiceBase
{
    ...
    private ServiceConfigDto _mywebapipoolConfig = new ServiceConfigDto { Application = ApplicationType.mywebapipool, LogLevel = LogEventLevel.Information, MonitoringFrequency = 10 };
    private ServiceConfigDto _mockServiceConfig = new ServiceConfigDto { Application = ApplicationType.MockService, LogLevel = LogEventLevel.Information, MonitoringFrequency = 10 };
    private ServiceConfigDto _controlServiceConfig = new ServiceConfigDto { Application = ApplicationType.ControlService, LogLevel = LogEventLevel.Information };
    ...
    public void savenewconfiga(ServiceConfigDto newConfig)
    {
    ...
    {
        LoggerHelper.ConfigureLogger(new LoggerService("C://Logs/monitoring-log.json", LogEventLevel.Information));
